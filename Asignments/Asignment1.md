...
## Question 1
- A) This is pseduo code it needs to be re-written for the assignment
```c
npoints = 10000
circle_count = 0
...
- B) This needs to be run for the assignment with varrying numbers of workers
```MPI
/**********************************************************************
